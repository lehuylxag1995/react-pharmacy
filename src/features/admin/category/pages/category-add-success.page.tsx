    ...
    <>
      ...
      <div className="m-4 bg-card text-card-foreground shadow border rounded-2xl">
        ...
        <div className="px-4 py-5 flex flex-col gap-2">
          <button className="bg-secondary text-secondary-foreground rounded-2xl py-2 cursor-pointer text-base font-medium">
            <Link to={"/admin/categories/add"}>Thêm danh mục khác</Link>
          </button>
          <button className="bg-primary text-primary-foreground rounded-2xl py-2 cursor-pointer text-base font-medium">
            <Link to={"/admin/categories"}>Quay về danh sách</Link>
          </button>
        </div>
      </div>
    </>
